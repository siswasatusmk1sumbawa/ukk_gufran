...
<body>
    ...
    ?>
        ...
        <div class="text-center">
            <div class="text-center">
            <h6><?= $data['judulfoto'] ?></h6>
            </div>
            <div class="text-center">
            <img src="gambar/<?= $data['lokasifile'] ?>" alt="foto" width="150px">
            <hr>
            <h6><i><?= $data['deskripsifoto'] ?></i><h6>
            <h6>upload by <?= $data['namalengkap'] ?></h6>
            </div>
            <div class="text-center">
            <?php
            $fotoid = $data['fotoid'];
            ...
            ?>
            <a href="admin.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-outline-danger">Like (<?= mysqli_num_rows($sql2) ?>)</button></a>
            <a href="komentar.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-primary">Komentar (<?= mysqli_num_rows($sql3) ?>)</button></a>
            </div>
        </div>
        </div>
    <?php
